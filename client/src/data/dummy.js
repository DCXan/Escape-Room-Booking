...
export const productsPerformance = [
  ...
  {
    image: product6,
    title: "Supreme The Beanstalk available",
    desc: "Market, Mall",
    rating: "Excellent",
    itemSold: "98%",
  ...
  {
    image: product4,
    title: "Stylish Two to Tango for night",
